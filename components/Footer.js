...
<div className="mx-auto w-full max-w-screen-xl p-5 py-10 lg:py-8">
  ...
  <div className="flex py-1 items-center">
    <ChevronRightIcon className="w-4 h-4 mr-1 text-gray-500" />
    <a href="http://dms.drogapharma.com/" className="hover:underline">Resources</a>
  </div>
  <div className="flex py-1 items-center">
    <ChevronRightIcon className="w-4 h-4 mr-1 text-gray-500" />
    <a href="https://drogapharma.com/contacts/" className="hover:underline">Contact Us</a>
  </div>
              </ul>
          </div>
          <div>
              ...
              <div className="flex py-1 items-center">
    <ChevronRightIcon className="w-4 h-4 mr-1 text-gray-500" />
    <a href="https://drogapharma.com/" className="hover:underline">Droga Pharma PLC</a>
  </div>
  <div className="flex py-1 items-center">
    <ChevronRightIcon className="w-4 h-4 mr-1 text-gray-500" />
    <a href="https://emaethiopia.com/" className="hover:underline">Ema Ethiopia PLC </a>
  </div>
  <div className="flex py-1 items-center">
    <ChevronRightIcon className="w-4 h-4 mr-1 text-gray-500" />
    <a href="https://drogaphysiotherapy.com/" className="hover:underline">Droga Physiotherapy</a>
  </div>
  <div className="flex py-1 items-center">
    <ChevronRightIcon className="w-4 h-4 mr-1 text-gray-500" />
    <a href="https://drogapharmacy.com/" className="hover:underline">Droga Pharmacy</a>
  </div>
              </ul>
          </div>
          <div>
              ...
              <div className="flex py-1 items-center">
    <ChevronRightIcon className="w-4 h-4 mr-1 text-gray-500" />
    <a href="" className="hover:underline">Tel +2511 90 804 8404</a>
  </div>
  <div className="flex py-1 items-center">
    <ChevronRightIcon className="w-4 h-4 mr-1 text-gray-500" />
    <a href="" className="hover:underline">Phone +251 90 804 8404</a>
  </div>
  <div className="flex py-1 items-center">
    <ChevronRightIcon className="w-4 h-4 mr-1 text-gray-500" />
    <a href="" className="hover:underline">Email: helpdesk@drogapharma.com</a>
  </div>
  <div className="flex py-1 items-center">
    <ChevronRightIcon className="w-4 h-4 mr-1 text-gray-500" />
    <a href="http://dms.drogapharma.com/" className="hover:underline">View Knowledge Base</a>
  </div>
              </ul>
          </div>
      </div>
